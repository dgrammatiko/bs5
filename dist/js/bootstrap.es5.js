var Bootstrap = (function (exports) {
  ...
  $$1({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT || !USES_TO_LENGTH }, {
  ...
  var setInternalState$2 = require('../internals/internal-state').set;
  ...
  for (var COLLECTION_NAME$1 in DOMIterables$1) {
    ...
    if (CollectionPrototype$1 && CollectionPrototype$1.forEach !== forEach$1) try {
      createNonEnumerableProperty$1(CollectionPrototype$1, 'forEach', forEach$1);
    } catch (error) {
  ...
  module.exports = collection$1('Set', function (init) {
  ...
  Joomla.Bootstrap.Initialise.Alert = function (el) {
  ...
  var alerts = Joomla.getOptions('bootstrap.alert'); // Force Vanilla mode!
  ...
  if (alerts && alerts.length) {
    alerts.map(function (selector) {
      Array.from(document.querySelectorAll(selector)).map(function (el) {
        return Joomla.Bootstrap.Initialise.Alert(el);
      });
    });
  }
  ...
  Joomla.Bootstrap.Initialise.Button = function (el) {
    if (!(el instanceof Element)) {
      return;
    }
  ...
  var buttons = Joomla.getOptions('bootstrap.button'); // Force Vanilla mode!
  ...
  if (buttons && buttons.length) {
    buttons.map(function (selector) {
      Array.from(document.querySelectorAll(selector)).map(function (el) {
        return Joomla.Bootstrap.Initialise.Button(el);
      });
    });
  }
  ...
  Joomla.Bootstrap.Initialise.Collapse = function (el, options) {
    if (!(el instanceof Element)) {
      return;
    }
  ...
  var collapses = Object.assign({}, Joomla.getOptions('bootstrap.collapse'), Joomla.getOptions('bootstrap.accordion')); // Force Vanilla mode!
  ...
  if (collapses) {
    Object.keys(collapses).map(function (collapse) {
      ...
      Array.from(document.querySelectorAll(collapse)).map(function (el) {
        return Joomla.Bootstrap.Initialise.Collapse(el, options);
      });
    });
  }
  ...
  Joomla.Bootstrap.Initialise.Carousel = function (el, options) {
    if (!(el instanceof Element)) {
      return;
    }
  ...
  var carousels = Joomla.getOptions('bootstrap.carousel'); // Force Vanilla mode!
  ...
  if (carousels) {
    Object.keys(carousels).forEach(function (carousel) {
      ...
      Array.from(document.querySelectorAll(carousel)).map(function (el) {
        return Joomla.Bootstrap.Initialise.Carousel(el, options);
      });
    });
  }
  ...
  var collection$2 = require('../internals/collection');
  var collectionStrong$1 = require('../internals/collection-strong');

  // `Map` constructor
  // https://tc39.es/ecma262/#sec-map-objects
  module.exports = collection$2('Map', function (init) {
  ...
  */
  ...
  var redefineAll$1 = require('../internals/redefine-all');
    ...
    if (!IS_PURE$1 && typeof NativePromise == 'function') {
      ...
      if (typeof $fetch == 'function') $$m({ global: true, enumerable: true, forced: true }, {
        ...
        fetch: function fetch(input /* , init */) {
          return promiseResolve(PromiseConstructor, $fetch.apply(global$5, arguments));
        }
      });
    }
  }
  ...
  Joomla.Bootstrap.Initialise.Dropdown = function (el, options) {
    if (!(el instanceof Element)) {
      return;
    }
  ...
  var dropdowns = Joomla.getOptions('bootstrap.dropdown'); // Force Vanilla mode!
  ...
  if (dropdowns) {
    Object.keys(dropdowns).forEach(function (dropdown) {
      ...
      Array.from(document.querySelectorAll(dropdown)).map(function (el) {
        return Joomla.Bootstrap.Initialise.Dropdown(el, options);
      });
    });
  }
  ...
  Joomla.Bootstrap.Initialise.Modal = function (modal, options) {
    ...
    Joomla.Bootstrap.Instances.Modal.set(modal, new Modal(modal, options)); // Comply with the Joomla API - Bound element.open/close

    modal.open = function () {
      Joomla.Bootstrap.Instances.Modal.get(modal).show(modal);
    };

    modal.close = function () {
      Joomla.Bootstrap.Instances.Modal.get(modal).hide();
  ...
  var modals = Joomla.getOptions('bootstrap.modal'); // Force Vanilla mode!
  ...
  Joomla.Bootstrap.Initialise.Popover = function (el, options) {
    if (!(el instanceof Element)) {
      return;
    }
  ...
  Joomla.Bootstrap.Initialise.Tooltip = function (el, options) {
  ...
  var popovers = Joomla.getOptions('bootstrap.popover'); // Force Vanilla mode!
  ...
  if (popovers) {
    Object.keys(popovers).forEach(function (popover) {
      ...
      Array.from(document.querySelectorAll(popover)).map(function (el) {
        return Joomla.Bootstrap.Initialise.Popover(el, options);
      });
    });
  }
  ...
  if (tooltips) {
    Object.keys(tooltips).forEach(function (tooltip) {
      ...
      Array.from(document.querySelectorAll(tooltip)).map(function (el) {
        return Joomla.Bootstrap.Initialise.Tooltip(el, options);
      });
    });
  }
  ...
  Joomla.Bootstrap.Initialise.Scrollspy = function (el, options) {
    if (!(el instanceof Element)) {
      return;
    }
  ...
  var scrollspys = Joomla.getOptions('bootstrap.scrollspy'); // Force Vanilla mode!
  ...
  if (scrollspys) {
    Object.keys(scrollspys).map(function (scrollspy) {
      var _options;
      ...
      }, _options["method"] = opt.method ? opt.method : null, _options);
      Array.from(document.querySelector(scrollspy)).map(function (el) {
        return Joomla.Bootstrap.Initialise.Scrollspy(el, options);
      });
    });
  }
  ...
  var tabs = Joomla.getOptions('bootstrap.tab'); // Force Vanilla mode!
  ...
  if (tabs) {
    var _loop = function _loop(tabSelector) {
      var nSelector = tabSelector.split('.')[1];
      ...
      if (tab) {
        ...
        if (related.length) {
          related.forEach(function (element) {
            ...
            var isActive = element.dataset.active !== '' ? true : false;
  ...
  Joomla.Bootstrap.Initialise.Toast = function (el, options) {
    if (!(el instanceof Element)) {
      return;
    }
  ...
  var toasts = Joomla.getOptions('bootstrap.toast'); // Force Vanilla mode!
  ...
  if (toasts) {
    Object.keys(toasts).map(function (toast) {
      ...
      Array.from(document.querySelectorAll(toast)).map(function (el) {
        return Joomla.Bootstrap.Initialise.Toast(el, options);
      });
    });
  }
